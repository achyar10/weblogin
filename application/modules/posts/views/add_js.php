<script type="text/javascript">
    ...
    function CategoriesCtrl($scope, $http) {
        ...
        $scope.addCategory = function() {
            ...
            $http({method: 'POST', headers: {'Content-Type': 'application/x-www-form-urlencoded'}, url: '<?php echo site_url('manage/posts/add_category'); ?>', data: "category_name=" + $scope.categoryText + "&<?php echo $this->security->get_csrf_token_name(); ?>=" + cct}).
